...
public class IntJoukko {
    ...
    public IntJoukko() {
        uusi(KAPASITEETTI, OLETUSKASVATUS);
    }
    ...
    public IntJoukko(int kapasiteetti, int kasvatuskoko) {
        uusi(kapasiteetti, kasvatuskoko);

    }
    
    public void uusi(int kapasiteetti, int kasvatuskoko) {
        if (kapasiteetti < 0) {
    ...
    public boolean lisaa(int luku) {
        ...
        if (!kuuluu(luku)) {
            ...
            if (alkioidenLkm % ljono.length == 0) {
                ...
                System.arraycopy(ljono, 0, taulukkoUusi, 0, ljono.length);
                ljono = taulukkoUusi;
            }
            return true;
        }
