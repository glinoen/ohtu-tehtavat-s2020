...
public class Stepdefs {
    ...
    public void newUserIsCreatedFromScratch(String username, String password) {
        newUserIsSelected();
        validUsernameAndValidPasswordAndMatchingPasswordConfirmationAreGiven(username, password);
        newUserIsCreated();     
    }
    ...
    public void userIsTriedToBeCreated(String username, String password) {
        newUserIsSelected();
        invalidUsernameAndInvalidPasswordAndMatchingPasswordConfirmationAreGiven(username, password);
        newUserIsNotCreated("username should have at least 3 characters");
    }
    
    
    @When("a valid username {string} and password {string} and matching password confirmation are entered")
    public void validUsernameAndValidPasswordAndMatchingPasswordConfirmationAreGiven(String username, String password) {
    ...
    @When("an invalid username {string} and invalid password {string} and matching password confirmation are entered")
    public void invalidUsernameAndInvalidPasswordAndMatchingPasswordConfirmationAreGiven(String username, String password) {
        newUserWith(username, password, password);
    }
    
    @When("a valid username {string} and short password {string} and matching password confirmation are entered")
    public void validUsernameAndShortPasswordAndMatchingPasswordConfirmationAreGiven(String username, String password) {
        newUserWith(username, password, password);
    }
    
    @When("a valid username {string} and password {string} and password confirmation {string} are entered")
    public void validUsernameAndShortPasswordAndNonmatchingPasswordConfirmationAreGiven(String username, String password, String passwordConfirmation) {
    ...
    public void newUserIsNotCreated(String string) {
